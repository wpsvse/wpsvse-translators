...
function wpsvse_cpt_translators() {
	...
	$labels = array(
		'name'                => _x( 'Validerare', 'Post Type General Name', 'wpsvse' ),
		'singular_name'       => _x( 'Validerare', 'Post Type Singular Name', 'wpsvse' ),
		'menu_name'           => __( 'Översättare', 'wpsvse' ),
		'name_admin_bar'      => __( 'Validerare', 'wpsvse' ),
		'parent_item_colon'   => __( 'Parent Item:', 'wpsvse' ),
		'all_items'           => __( 'Alla validerare', 'wpsvse' ),
		'add_new_item'        => __( 'Lägg till ny validerare', 'wpsvse' ),
		'add_new'             => __( 'Ny validerare', 'wpsvse' ),
		'new_item'            => __( 'Ny validerare', 'wpsvse' ),
		'edit_item'           => __( 'Redigera validerare', 'wpsvse' ),
		'update_item'         => __( 'Uppdatera validerare', 'wpsvse' ),
		'view_item'           => __( 'Visa validerare', 'wpsvse' ),
		'search_items'        => __( 'Sök validerare', 'wpsvse' ),
		'not_found'           => __( 'Inga validerare kunde hittas', 'wpsvse' ),
		'not_found_in_trash'  => __( 'Inga validerare kunde hittas i papperskorgen', 'wpsvse' ),
	);
	$rewrite = array(
		'slug'                => 'oversattningsvaliderare',
		'with_front'          => true,
		'pages'               => true,
		'feeds'               => true,
	);
